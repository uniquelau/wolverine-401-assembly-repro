...
{
    [DbContext(typeof(WolverineTestContext))]
    partial class WolverineTestContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wolverine.EntityFrameworkCore.Internals.IncomingMessage", b =>
                {
                    ...
                    b.ToTable("wolverine_incoming_envelopes", "dbo", t =>
                        {
            ...
            modelBuilder.Entity("Wolverine.EntityFrameworkCore.Internals.OutgoingMessage", b =>
                {
                    ...
                    b.ToTable("wolverine_outgoing_envelopes", "dbo", t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });

            modelBuilder.Entity("WolverineTest.Web.Data.DbUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WolverineTest.Web.Data.DbUser", null)
                        .WithMany()
